...
class ScatteringStage(RenderStage):
    ...
    def set_shaders(self):
        self._target.set_shader(
            self._load_plugin_shader("Scattering", "Shader/ApplyScattering.frag.glsl"))
        self._target_cube.set_shader(
            self._load_plugin_shader("Scattering", "Shader/ScatteringEnvmap.frag.glsl"))

        mip_shader = self._load_plugin_shader("Scattering", "Shader/DownsampleEnvmap.frag.glsl") 
