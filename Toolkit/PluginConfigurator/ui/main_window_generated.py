...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lst_plugins.setGeometry(QtCore.QRect(20, 140, 251, 631))
...
"}"))
        ...
        self.frame_details.setGeometry(QtCore.QRect(300, 140, 881, 631))
        self.frame_details.setStyleSheet(_fromUtf8(""))
        ...
        self.table_plugin_settings.setGeometry(QtCore.QRect(30, 150, 831, 461))
        ...
        self.lbl_select_plugin.setGeometry(QtCore.QRect(560, 410, 391, 31))
        font = QtGui.QFont()
        ...
        self.lbl_restart_pipeline.setGeometry(QtCore.QRect(680, 80, 481, 31))
        font = QtGui.QFont()
...
"", None))
        ...
        self.lbl_select_plugin.setText(_translate("MainWindow", "Select a Plugin to change its settings", None))
        self.lbl_restart_pipeline.setText(_translate("MainWindow", "Pipeline needs to be restarted in order to see all setting changes!", None))
