...
class ShaderTemplate(DebugObject):
    ...
    def create(self):
        ...
        line_prefix = lambda src, linenr: "/* " + src + " " + str(linenr).zfill(4) + " */ "
        ...
        for src_index, line in enumerate(shader_lines):
            ...
            if stripped_line.startswith("%") and stripped_line.endswith("%"):
                ...
                if hook_name in self._template_values:
                    ...
                    for nr, line_i in enumerate(insertions):
                        ...
                        if line_i.startswith("#"):
                            ...
                            parsed_lines.append(line_prefix("E", nr) + indentation + line_i)
                ...
                # Otherwise add a comment showing the line in the template
                    ...
                    parsed_lines.append(line_prefix("T", src_index) + line.rstrip())
