...
class RenderingPipeline(DebugObject):
    ...
    def create(self):
        ...
        self.haveEdgePreservingBlur = False
        ...
        if self.occlusion.requiresBlurring() or self.settings.enableGlobalIllumination:
            self._createEdgePreservingBlur()
    ...
    def _setShaderInputs(self):
        ...
        if self.haveEdgePreservingBlur:
            self.edgePreservingBlurH.setShaderInput(
                "colorTex", self.edgePreservingBlurV.getColorTexture())
            ...
            if self.settings.haveOcclusion:
                sceneInput = self.occlusionBuffer.getColorTexture()
            else:
                assert(False)

            self.edgePreservingBlurH.setShaderInput(
                "sourceTex", sceneInput)
            self.edgePreservingBlurV.setShaderInput(
                "colorTex",
                sceneInput)
    ...
    def _createEdgePreservingBlur(self):
        """ Creates the buffers needed to blur the occlusion and GI """
        self.edgePreservingBlurV = RenderTarget("EdgePreservingBlurV")
        self.edgePreservingBlurV.addColorTexture()
        self.edgePreservingBlurV.prepareOffscreenBuffer()

        self.edgePreservingBlurH = RenderTarget("EdgePreservingBlurH")
        self.edgePreservingBlurH.addColorTexture()
        self.edgePreservingBlurH.prepareOffscreenBuffer()

        self.haveEdgePreservingBlur = True
    ...
    def _setEdgePreservingBlurShader(self):
        ...
        self.edgePreservingBlurV.setShader(blurVShader)
        self.edgePreservingBlurH.setShader(blurHShader)
    ...
    def reloadShaders(self):
        ...
        if self.haveEdgePreservingBlur:
            self._setEdgePreservingBlurShader()
