...
def process_header(header, templates):
    ...
    for method in methods:
        ...
        doc = ["Auto-Geneated method " + current_cls["name"] + "::" + method_name, ""]
        params = ["self"]
        method_str = ""
        ...
        if template_key in templates:
            ...
            doc = ["Manually templated method " + current_cls["name"] + "::" + method_name, "Source: ./Templates/" + current_cls["name"] + ".template.py"]
...
if __name__ == "__main__":
    ...
    with open("RSNativePython.py", "w") as handle:
        handle.write(OUTPUT)
