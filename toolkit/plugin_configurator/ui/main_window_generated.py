...
""))
        ...
        self.frame_details.setStyleSheet(_fromUtf8("QFrame {background: #ececec; }"))
...
"border-width: 0 0 0px 0;"))
        ...
        self.frame.setStyleSheet(_fromUtf8("background: #333; border-right: 1px solid #222;"))
...
"border-right: 0px solid #9A3;"))
        ...
        self.lbl_restart_pipeline.setGeometry(QtCore.QRect(490, 10, 421, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.lbl_restart_pipeline.setFont(font)
        self.lbl_restart_pipeline.setAutoFillBackground(False)
        self.lbl_restart_pipeline.setStyleSheet(_fromUtf8("color: #F44;background: #fff;padding: 5px; border: 3px solid #F44;"))
